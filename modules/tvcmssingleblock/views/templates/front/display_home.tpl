...
* @author PrestaShop SA <contact@prestashop.com>
    ...
    *}
    ...
    <div class='container-fluid tvcmssingle-block' style="background-image:url({$dis_arr_result.path}{$dis_arr_result.data.image})">
        <div class='container tvsingle-block container'>
            ...
            {* <a href="{$dis_arr_result.data.link}" class="tvsingle-block-image-info-wrapper row" title="{$dis_arr_result.data.title}">
                <div class="tv-single-block-image-wrapper-1 "> *}
                    <div class="tvsingle-block-image-content-inner">
                        ...
                        {* <div class="tv-singleblock-content-one">
                            ...
                            <div class="tv-single-block-content">
                                <h3 class="tvsingle-block-sub-description">
                                    {$dis_arr_result.data.sub_description nofilter}
                                </h3>
                                <h6 class="tvsingle-block-title">
                                    {$dis_arr_result.data.title nofilter}
                                </h6>
                                <div class="tvsingle-block-desc">
                                    {$dis_arr_result.data.description nofilter}
                                </div>
                                <div class="tvsingle-block-btn-link-wrapper">
                                    <a href="{$dis_arr_result.data.link}" class="tvsingle-bolck-btn-link tvsingle-bolck-btn tvall-inner-btn"><span>{$dis_arr_result.data.btn_caption}</span></a>
                                </div>
                            </div>
