...
{block name="input"}
    {if $input.type == 'BtnInstallData'}
            ...
            <button class="btn btn-primary tvcms-sample-install-btn" type="submit" onclick="return confirmAction()" name="submitTvcmsSampleinstall">{l s='Install Sample Data' mod="tvcmssingleblock"}</button>
    {/if}
            ...
            {foreach from=$languages item=language}
                        ...
                        <div class="dummyfile input-group">
                            ...
                            <span class="input-group-btn">
                                <button id="{$input.name|escape:'htmlall':'UTF-8'}_{$language.id_lang|escape:'htmlall':'UTF-8'}-selectbutton" type="button" name="submitAddAttachments" class="btn btn-default">
                                    <i class="icon-folder-open"></i> {l s='Choose a file' mod='tvcmssingleblock'}
                                </button>
                            </span>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <div id="{$input.name|escape:'htmlall':'UTF-8'}-{$language.id_lang|escape:'htmlall':'UTF-8'|escape:'htmlall':'UTF-8'}-images-thumbnails" class="col-lg-12">
                        ...
                        <p class="help-block">{l s='Please Select Image.' mod='tvcmssingleblock'} (Size:- {$width|escape:'htmlall':'UTF-8'} X {$height|escape:'htmlall':'UTF-8'})</p>
                    </div>
                </div>
