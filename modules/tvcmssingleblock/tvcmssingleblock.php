...
class TvcmsSingleBlock extends Module
{
    ...
    public function createDefaultData()
    {
        ...
        foreach ($languages as $lang) {
            ...
            $result['TVCMSSINGLEBLOCK_SINGLE_BLOCK_IMG'][$lang['id_lang']] = 'demo_img_2.jpg';
            ...
            $result['TVCMSSINGLEBLOCK_SINGLE_BLOCK_TITLE'][$lang['id_lang']] = 'Oraganic Fruit & Vegetables';
            $result['TVCMSSINGLEBLOCK_SINGLE_BLOCK_SUB_DESCRIPTION'][$lang['id_lang']] = '100% Natural Farm Fresh Food';
            $result['TVCMSSINGLEBLOCK_SINGLE_BLOCK_DESCRIPTION'][$lang['id_lang']] = 'BIG SAVING ON WEEKEND SALE, GRAB IT NOW';
            $result['TVCMSSINGLEBLOCK_SINGLE_BLOCK_BTN_CAPTION'][$lang['id_lang']] = 'SHOP NOW';
        }
    ...
    public function postProcess()
    {
        ...
        if (Tools::isSubmit('submittvcmsSingleBlockMainTitleForm') && Tools::getValue('tvinstalldata') == '0') {
            ...
            $message .= $this->displayConfirmation($this->l('Single Block is Updated.'));
        }
