...
class TvcmsCategorySlider extends Module
{
    ...
    public function createVariable()
    {
        ...
        foreach ($languages as $lang) {
            ...
            $result['TVCMSCATEGORY_SLIDER_SUB_DESCRIPTION'][$lang['id_lang']] = 'Pure Organic';
    ...
    public function showFrontSideResult()
    {
        ...
        $BackimagePath = _MODULE_DIR_.$this->name."/views/img/";
        $this->context->smarty->assign('BackimagePath', $BackimagePath);
        $Backimage = Configuration::get('TVCMSCATEGORY_SLIDER_IMG', $id_lang);
        $this->context->smarty->assign('Backimage', $Backimage);
