...
function acceptComment(id)
{
	...
	if (id)
		form.elements['id_tvcmsproduct_comment'].value = id;
...
function delComment(id, confirmation)
{
	...
	if (answer)
	{
		...
		if (id)
			form.elements['delete_id_tvcmsproduct_comment'].value = id;
...
function editCriterion(id)
{
	...
	form.elements['id_tvcmsproduct_comment_criterion'].value = id;
...
$( document ).ready(function() {
	$('select#id_tvcmsproduct_comment_criterion_type').change(function() {
		// PS 1.6
	...
	$('select#id_tvcmsproduct_comment_criterion_type').trigger( "change" );
});