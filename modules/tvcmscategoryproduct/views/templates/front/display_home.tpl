    ...
    <div class='container-fluid tvcmstabcategory-product-slider'>
        <div class='container tvtabcategory-product-slider'>
            ...
            <div class='tvtabcategory-tab-product'>
                <div class='tvtabcategory-all-tab tvtabcategory-product-desktop-view tvall-product-branner col-xl-2 col-lg-3 col-md-3 col-sm-4'>
                ...
                <div class='tvtabcategory-all-product tvimage-true col-xl-10 col-lg-9 col-md-9 col-sm-8 col-xs-12'>{*
