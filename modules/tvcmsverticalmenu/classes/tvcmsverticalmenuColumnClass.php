...
*/
class TvcmsVerticalMenuColumnClass extends ObjectModel
{
    public $id_row;
    ...
    public static $definition = [
        'table' => 'tvcmsverticalmenu_column',
        'primary' => 'id_column',
        'multilang_shop' => true,
        'fields' => [
            'id_row' => [
            ...
            'width' => ['type' => self::TYPE_STRING, 'shop' => true, 'validate' => 'isCleanHtml', 'size' => 255],
    ...
    public function __construct($id_column = null, $id_lang = null, $id_shop = null, Context $context = null)
    {
        ...
        Shop::addTableAssociation('tvcmsverticalmenu_column', ['type' => 'shop']);
    }
