            ...
            <div id='tvcmsdesktop-vertical-menu'>
                <div class='tvcmsverticalmenu'>
                    <div id="tvverticalmenu" class="tvcmsvertical-menu">
                            <div class="tvallcategories tvallcategories-wrapper">
                                <div class="tvcategory-title-wrapper">
                                    <div class="tvleft-right-title facet-label">
                                        <span>{l s='All Categories' mod='tvcmsverticalmenu'}</span>
                                    </div>
                                    <div class="tvleft-right-title-toggle">
                                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="56px" y="34px" width="39px" height="30px" viewBox="0 0 30 30" style="enable-background:new 0 0 700 700;" xml:space="preserve">
                                            <rect id="XMLID_1_" x="0" y="0" style="fill:#333333;" width="20" height="2" />
                                            <rect id="XMLID_1_" x="0" y="5" style="fill:#333333;" width="20" height="2" />
                                        </svg>
                                    </div>
                                    <span class="tvcmsvertical-menu-icon hidden-lg-up"><i class="material-icons tvcmsvertical-menu-i">&#xe5cf;</i></span>
                                </div>
                            </div>
