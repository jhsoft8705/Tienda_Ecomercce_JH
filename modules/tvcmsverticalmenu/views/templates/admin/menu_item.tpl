...
<form id="module_form" class="defaultForm form-horizontal" action="index.php?controller=AdminModules&amp;configure=tvcmsverticalmenu&amp;token={Tools::getAdminTokenLite('AdminModules')|escape:'html':'UTF-8'}" method="post" enctype="multipart/form-data" novalidate="">
<div class="panel"><h3><i class="icon-list-ul"></i> {l s='Menu Item' mod='tvcmsverticalmenu'}</h3>
	<div class="form-wrapper" id="menuContent" >
		<div class="form-group tvcmsvertical-type-link">
			<label class="control-label col-lg-3">{l s='Type Link' mod='tvcmsverticalmenu'}</label>
			<div class="col-lg-9">
				<div class="radio tvcmsvertical-radio">
		...
		<div class="form-group tvcmsvertical-menu-title" {if $menu->type_link == 0}style="display:none"{/if}>
			<label class="control-label col-lg-3">{l s='Title' mod='tvcmsverticalmenu'}</label>
			<div class="col-lg-9">
		...
		<div class="form-group tvcmsvertical-menu-link" {if $menu->type_link == 0}style="display:none"{/if}>
			<label class="control-label col-lg-3">{l s='Link' mod='tvcmsverticalmenu'}</label>
			<div class="col-lg-9">
				{foreach from=$languages item=language}
					{if $languages|count > 1}
						<div class="translatable-field lang-{$language.id_lang|intval}" {if $language.id_lang != $id_language}style="display:none"{/if}>
		...
		<div class="form-group ps_link" {if $menu->type_link == 1}style="display:none"{/if}>
			<label class="control-label col-lg-3">{l s='PrestaShop Link' mod='tvcmsverticalmenu'}</label>
			<div class="col-lg-9">
		...
		<div class="form-group show_sub" {if $menu->type_link == 1}style="display:none"{/if}>
			<label class="control-label col-lg-3">{l s='Show sub categories' mod='tvcmsverticalmenu'}</label>
			<div class="col-lg-9">
		...
		<div class="form-group">
			<label class="control-label col-lg-3">{l s='Sub title' mod='tvcmsverticalmenu'}</label>
			<div class="col-lg-9">
				{foreach from=$languages item=language}
					{if $languages|count > 1}
						<div class="translatable-field lang-{$language.id_lang|intval}" {if $language.id_lang != $id_language}style="display:none"{/if}>
		...
		<div class="form-group tvcmsvertical-type-icon">
			<label class="control-label col-lg-3">{l s='Type icon' mod='tvcmsverticalmenu'}</label>
			<div class="col-lg-9">
				<div class="radio tvcmsvertical-radio">
		...
		<div class="form-group tvcmsvertical-fw-icon" {if $menu->type_icon == 0}style="display:none"{/if}>
			<label class="control-label col-lg-3">{l s='Font-Awesome Icon' mod='tvcmsverticalmenu'}</label>
			<div class="col-lg-9">
				...
				<p>{l s='Put class icon of Font-Awesome at :' mod='tvcmsverticalmenu'} <a href="http://fortawesome.github.io/Font-Awesome/3.2.1/icons/">http://fortawesome.github.io/Font-Awesome/3.2.1/icons/.</a> ex: icon-sun</p>
				<p>{l s='Or put class icon of Pe-icon-7-stroke at :' mod='tvcmsverticalmenu'} <a href="http://themes-pixeden.com/font-demos/7-stroke/">http://themes-pixeden.com/font-demos/7-stroke/.</a> ex: pe-7s-album</p>
			</div>
		</div>
		<div class="form-group tvcmsvertical-img-icon" {if $menu->type_icon == 1}style="display:none"{/if}>
			<label class="control-label col-lg-3">{l s='Image Icon' mod='tvcmsverticalmenu'}</label>
			<div class="col-lg-9">
				<div class="col-lg-6">
					...
					{if $menu->type_icon == 0 && isset($menu->icon) && $menu->icon != ''}
						...
						{if isset($menu->id)}
							<a href="index.php?controller=AdminModules&amp;configure=tvcmsverticalmenu&amp;tab_module=front_office_features&amp;module_name=tvcmsverticalmenu&amp;token={Tools::getAdminTokenLite('AdminModules')|escape:'html':'UTF-8'}&amp;removeIcon=1&amp;id_tvcmsverticalmenu={$menu->id|intval}" id="del_icon">Remove</a>
						{/if}
					{/if}
						<script type="text/javascript">
						$(document).ready(function(){
	...
	<div class="form-group">
		<label class="control-label col-lg-3">{l s='Align of subMenu' mod='tvcmsverticalmenu'}</label>
		<div class="col-lg-9">
			<select class="form-control fixed-width-lg" name="align_sub" id="align_sub">
				<option value="tvcmsvertical-sub-left">{l s='Left' mod='tvcmsverticalmenu'}</option>
				<option value="tvcmsvertical-sub-right">{l s='Right' mod='tvcmsverticalmenu'}</option>
				<option value="tvcmsvertical-sub-auto">{l s='Auto' mod='tvcmsverticalmenu'}</option>
			</select>
			<script type="text/javascript">
				$(document).ready(function(){
					...
					{else}
						var align_sub_val = 'tvcmsvertical-sub-auto';
					{/if}
	...
	<div class="form-group">
		<label class="control-label col-lg-3">{l s='Sub menu column' mod='tvcmsverticalmenu'}</label>
		<div class="col-lg-9">
	...
	<div class="form-group">
		<label class="control-label col-lg-3">{l s='Class' mod='tvcmsverticalmenu'}</label>
		<div class="col-lg-5">
			<input type="text" class="class" id="class" name="class" value="{if $menu->class}{$menu->class|escape:'html':'UTF-8'}{/if}"/>
		</div>
	</div>
	<div class="form-group">
		<label class="control-label col-lg-3">{l s='Active' mod='tvcmsverticalmenu'}</label>
		<div class="col-lg-9">
			<span class="switch prestashop-switch fixed-width-lg">
	...
	<div class="panel-footer">
		<input type="hidden" name="id_tvcmsverticalmenu" id="id_tvcmsverticalmenu" value="{if isset($menu->id)}{$menu->id|intval}{/if}"/>
