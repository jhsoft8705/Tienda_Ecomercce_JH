...
class TvcmsVerticalMenuData
{
    public function initData()
    {
        ...
        foreach ($languages as $language) {
            ...
            (2,' . $id_shop . ',' . $language['id_lang'] . ', "Organic", "#", ""),
            (3,' . $id_shop . ',' . $language['id_lang'] . ', "Products", "#", "hot"),
            (4,' . $id_shop . ',' . $language['id_lang'] . ', "Cocoa Powder", "#", ""),
            (5,' . $id_shop . ',' . $language['id_lang'] . ', "Fruit Powder", "#", ""),
            (6,' . $id_shop . ',' . $language['id_lang'] . ', "Nuts & Seeds", "#", ""),
            (7,' . $id_shop . ',' . $language['id_lang'] . ', "Mango Drink", "#", ""),
            (8,' . $id_shop . ',' . $language['id_lang'] . ', "others", "#", "");');
            ...
            (1,' . $id_shop . ',' . $language['id_lang'] . ', "Organic Products", "#", ""),
            (2,' . $id_shop . ',' . $language['id_lang'] . ', "Organic Products", "#", ""),
            (3,' . $id_shop . ',' . $language['id_lang'] . ', "Organic Products", "#", ""),
            (4,' . $id_shop . ',' . $language['id_lang'] . ', "Organic Products", "#", ""),
            (5,' . $id_shop . ',' . $language['id_lang'] . ', "Organic Products", "#", ""),
            (6,' . $id_shop . ',' . $language['id_lang'] . ', "Organic Products", "#", ""),
            (7,' . $id_shop . ',' . $language['id_lang'] . ', "Organic Products", "#", ""),
            (8,' . $id_shop . ',' . $language['id_lang'] . ', "Organic Products", "#", ""),
