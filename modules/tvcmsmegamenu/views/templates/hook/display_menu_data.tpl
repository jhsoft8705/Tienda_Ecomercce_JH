            ...
            <ul class="menu-content">
                ...
                <li class="level-1 {$menu.class|escape:'html':'UTF-8'}{if count($menu.sub_menu) > 0}parent{/if}">
                    <a href="{$menu.link|escape:'html':'UTF-8'}" title="{$menu.title|escape:'html':'UTF-8'}">
                        ...
                        <img class="img-icon" src="{$icon_path|escape:'html':'UTF-8'}{$menu.icon|escape:'html':'UTF-8'}" alt="{$menu.title|escape:'html':'UTF-8'}" {if $menu.width_icon && $menu.height_icon}width="{$menu.width_icon}" height="{$menu.height_icon}" {/if}/>{elseif $menu.type_icon==1 && $menu.icon !='' }<i class="{$menu.icon|escape:'html':'UTF-8'}"></i>{/if}{if $menu.active_title == 1}<span>{$menu.title|escape:'html':'UTF-8'}</span>{/if}{if $menu.subtitle != ''}<span class="menu-subtitle" {if $menu.sub_title_stylesheet !='' }style="{$menu.sub_title_stylesheet}" {/if}> {$menu.subtitle|escape:'html':'UTF-8'}</span>{/if} </a> <span class="icon-drop-mobile"></span>
