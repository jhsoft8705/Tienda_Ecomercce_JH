...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  ...
  'file_dependency' => 
  array (
    'fb2a1f63771464402596902e0a27b6fed27f1031' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Tienda_Jh_soft_ecommerce\\modules\\tvcmsthemeoptions\\views\\templates\\front\\display_layout.tpl',
      1 => 1705965267,
      2 => 'file',
    ),
  ),
...
.png" alt="header-layout" data-layout="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['header_name']->value, ENT_QUOTES, 'UTF-8');?>
...
.png" alt="header-mobile-layout" data-layout="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['header_mobile_name']->value, ENT_QUOTES, 'UTF-8');?>
"/><p class="tvlayout-title"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Header','mod'=>'tvcmsthemeoptions'),$_smarty_tpl ) );?>
 <?php echo htmlspecialchars((isset($_smarty_tpl->tpl_vars['__smarty_foreach_index']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_index']->value['index'] : null)+1, ENT_QUOTES, 'UTF-8');?>
</p></label></div><?php
}
...
.png" alt="footer-layout" data-layout="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['footer_name']->value, ENT_QUOTES, 'UTF-8');?>
...
</span></button></div><div class="tvtheme-layout-icon"><i class='material-icons'>&#xe871;</i></div></form></div></div><?php }
}
}
