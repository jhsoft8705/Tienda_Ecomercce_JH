...
/* Smarty version 3.1.47, created on 2024-01-22 23:24:14
  from 'C:\xampp\htdocs\Tienda_Jh_soft_ecommerce\themes\v1_organic_33\templates\_partials\desk-header-7.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.47',
  'unifunc' => 'content_65af3f6e8ec749_41314976',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd08eab98fe03590c1dfbf33cc095a4ebaa0f63b2' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Tienda_Jh_soft_ecommerce\\themes\\v1_organic_33\\templates\\_partials\\desk-header-7.tpl',
      1 => 1705965268,
      2 => 'file',
    ),
  ),
...
function content_65af3f6e8ec749_41314976 (Smarty_Internal_Template $_smarty_tpl) {
?>    <div class="tvcmsdesktop-top-header-wrapper header-7" data-header-layout="7"><div class="tvcms-header-nav"><div class='tvcmsdesktop-top-header tvcontainer-layout-nav'><div class="container tvcmsdesktop-top-wrapper"><div class='tvheader-offer-wrapper col-xl-6 col-lg-6 col-md-6 col-sm-12'><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0], array( array('h'=>'displayTopOfferText'),$_smarty_tpl ) );?>
...
}?></div></div></div></div></div><div class='container-fluid tvcmsdesktop-top-second hidden-md-down'><div class="container"><div class="tvcmsdesktop-top-header-box row"><div class='col-sm-12 col-md-2 col-lg-2 col-xl-4 tvcms-header-logo-wrapper'><div class="hidden-sm-down tvcms-header-logo" id="tvcmsdesktop-logo"><?php if ($_smarty_tpl->tpl_vars['withData']->value) {?><div class="tv-header-logo"><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['urls']->value['base_url'], ENT_QUOTES, 'UTF-8');?>
"><img class="logo img-responsive" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shop']->value['logo'], ENT_QUOTES, 'UTF-8');?>
" alt="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shop']->value['name'], ENT_QUOTES, 'UTF-8');?>
" loading="lazy" height="35" width="201"></a></div><?php }?></div></div><div class="col-sm-12 col-md-6 col-lg-5 col-xl-4 tvcmsheader-search"><div class='tvcmssearch-wrapper' id="_desktop_search"><?php if ($_smarty_tpl->tpl_vars['withData']->value) {
...
}?></div></div><div class="col-sm-12 col-md-4 col-lg-5 col-xl-4 tvcmsheader-nav-right"><div class="tv-contact-account-cart-wrapper"><div class="ttvcms-wishlist-icon"><?php if ($_smarty_tpl->tpl_vars['withData']->value) {
...
}?></div></div></div></div></div></div><div class="tvcms-header-menu-offer-wrapper tvcmsheader-sticky"><div class="position-static tvcms-header-menu tvcontainer-layout-header container"><div class="tvcmsmain-menuverticl-wrapper col-xl-3 col-lg-3 col-md-3"><?php if ($_smarty_tpl->tpl_vars['withData']->value) {
...
}?></div><div class='tvcmsmain-menu-wrapper col-xl-7 col-lg-7 col-md-7'><div id='tvdesktop-megamenu'><?php if ($_smarty_tpl->tpl_vars['withData']->value) {
...
}?></div></div><div class="tvcmsdesktop-contact col-xl-2 col-lg-2 col-md-2"><?php if ($_smarty_tpl->tpl_vars['withData']->value) {
