  ...
  <form id="guestOrderTrackingForm" action="{$urls.pages.guest_tracking}" method="get">
    ...
    <section class="form-fields">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-6">
          <input class="form-control" name="order_reference" type="text" size="8" value="{if isset($smarty.request.order_reference)}{$smarty.request.order_reference}{/if}" >
      ...
      <div class="form-group row">
        ...
        <div class="col-md-6">
          <input class="form-control" name="email" type="email" value="{if isset($smarty.request.email)}{$smarty.request.email}{/if}" >
        </div>
      </div>
    ...
    <footer class="form-footer text-center clearfix">
      <button class="tvall-inner-btn" type="submit">
