...
{strip}
    ...
    <div id="content" class="page-content page-stores">
        <div class="row tvstore-address-in">
            {foreach $stores as $store}
            <article id="store-{$store.id}" class="store-item col-xs-12 col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="store-item-container clearfix">
                    ...
                    <div class="store-description">
                        <h5>{$store.name}</h5>
                        <p>{$store.address.formatted nofilter}</p>
