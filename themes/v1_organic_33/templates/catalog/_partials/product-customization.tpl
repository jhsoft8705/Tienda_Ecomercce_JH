    ...
    <div class="card card-block">
      ...
      {block name='product_customization_form'}
        <form method="post" action="{$product.url}" enctype="multipart/form-data">
              ...
              <li class="product-customization-item">
                ...
                {elseif $field.type == 'image'}
                  {if $field.is_customized}
                    <br>
                    <img data-src="{$field.image.small.url}" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" height="{$field.image.small.height}" width="{$field.image.small.width}">
                  ...
                  <span class="custom-file">
                    ...
                    <button class="tvall-inner-btn">
                      <span>{l s='Choose file' d='Shop.Theme.Actions'}</span>
                    </button>
                  </span>
          ...
          <div class="clearfix">
            <button class="tvall-inner-btn float-xs-right" type="submit" name="submitCustomizedData">
              <span>{l s='Save Customization' d='Shop.Theme.Actions'}</span>
            </button>
          </div>
        </form>
      {/block}
