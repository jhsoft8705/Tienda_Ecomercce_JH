...
* @author PrestaShop SA <contact@prestashop.com>
    ...
    *}
    ...
    <div class="tvcmsdesktop-top-header-wrapper header-7" data-header-layout="7">
        <div class="tvcms-header-nav">
            <div class='tvcmsdesktop-top-header tvcontainer-layout-nav'>
                <div class="container tvcmsdesktop-top-wrapper">
                    ...
                    <div class='tvheader-language-currency-wrapper col-xl-6 col-lg-6 col-md-6 col-sm-12'>
                        <div class="tvheader-compare">{if $withData}{hook h='displayNavProductCompareBlock'}{/if}</div><div class="tvheader-language">{if $withData}{hook h='displayNavLanguageBlock'}{/if}</div><div class="tvheader-currency">{if $withData}{hook h='displayNavCurrencyBlock'}{/if}</div>
                    </div>
                </div>
            </div>
        </div>
        <div class='container-fluid tvcmsdesktop-top-second hidden-md-down'>
            <div class="container">
                <div class="tvcmsdesktop-top-header-box row">
                    <div class='col-sm-12 col-md-2 col-lg-2 col-xl-4 tvcms-header-logo-wrapper'>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-5 col-xl-4 tvcmsheader-search">
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-5 col-xl-4 tvcmsheader-nav-right">
        ...
        c4.497,0,8.15,3.655,8.15,8.152C23.839,13.338,20.186,16.992,15.688,16.992"></path>
                                ...
                                {/if}
                            </div><div id="_desktop_cart_manage" class="tvcms-header-cart">
                                {if $withData}
        ...
        <div class="tvcms-header-menu-offer-wrapper tvcmsheader-sticky">
            <div class="position-static tvcms-header-menu tvcontainer-layout-header container">
                <div class="tvcmsmain-menuverticl-wrapper col-xl-3 col-lg-3 col-md-3">
                    {if $withData}{hook h='displayNavFullWidth'}{/if}
                </div>
                <div class='tvcmsmain-menu-wrapper col-xl-7 col-lg-7 col-md-7'>
                ...
                <div class="tvcmsdesktop-contact col-xl-2 col-lg-2 col-md-2">{if $withData}{hook h='displayNav1'}{/if}</div>
            </div>
        </div>
    </div>
    {/strip}