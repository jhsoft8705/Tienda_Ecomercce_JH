...
{strip}
    <div class="tvcmsdesktop-top-header-wrapper header-6" data-header-layout="6"> 
        ...
        <div class='container-fluid tvcmsdesktop-top-second hidden-md-down'>
            <div class="container">
                <div class="row tvcmsdesktop-top-header-box">
                    <div class='col-sm-12 col-md-2 col-lg-2 col-xl-2 tvcms-header-logo-wrapper'>
                    ...
                    <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8 tvcms-header-menu-offer-wrapper tvcmsheader-sticky">
                    ...
                    <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2 tvcmsheader-nav-right">
        ...
        c4.497,0,8.15,3.655,8.15,8.152C23.839,13.338,20.186,16.992,15.688,16.992"></path> 
                        ...
                        <div class="tvcmsmain-menuverticl-wrapper col-xl-3 col-lg-3 col-md-3 tvforce-hide">
