...
*}
{strip}
    <div class="tvcmsdesktop-top-header-wrapper tvheader-checkout">
        ...
        <div class='container-fluid tvcmsdesktop-top-second hidden-md-down'>
            <div class="container">
                <div class="row tvcmsdesktop-top-header-box">
                    <div class='col-lg-6 col-md-6 col-xl-6 col-sm-12 tvcms-header-logo-wrapper'>
                    ...
                    <div class="col-lg-8 col-md-8 col-xl-8 col-sm-12 tvcms-header-menu-offer-wrapper tvcmsheader-sticky tvforce-hide">
                    ...
                    <div class="col-lg-2 col-md-2 col-xl-2 col-sm-12 tvcmsheader-nav-right tvforce-hide">
