...
{strip}
{if $GetStatusBrand == 1}
<div id="search_filters_brands" class='tvfilter-brand-list-wrapper'>
  <div class="facet">
    <div class="tvleft-right-title-wrapper">
        {if $display_link_brand}
        <a class="tvleft-right-title facet-label" href="{$page_link}" title="{l s='Brands' d='Shop.Theme.Catalog'}">{/if}
    ...
    <div class="tvsearch-filter-brand-wrapper tvside-panel-dropdown">
      {if $brands}
...
{else if $GetStatusBrand == 0 && $page.page_name == 'index'}
<div id="search_filters_brands" class='tvfilter-brand-list-wrapper'>
  <div class="facet">
    <div class="tvleft-right-title-wrapper">
        {if $display_link_brand}
